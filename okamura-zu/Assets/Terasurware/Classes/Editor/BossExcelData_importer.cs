...
public class BossExcelData_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/ExcelData/BossExcelData.xls";
	private static readonly string exportPath = "Assets/ExcelData/BossExcelData.asset";
	private static readonly string[] sheetNames = { "Tokyo","Hokkaido", };
